        ...
        <footer id="contact" className="relative bg-dark-slate pt-24 text-white overflow-hidden">
            ...
            <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-12 border-b border-white/10 pb-16 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                        <h3 className="mb-8 text-sm font-bold uppercase tracking-widest text-brand-red">Contact Us</h3>
                    ...
                    <div className="bg-white/5 p-8 border border-white/10">
                        ...
                        <Link to="/resources" className="flex w-full items-center justify-center gap-3 bg-brand-red px-6 py-4 text-sm font-bold uppercase tracking-widest text-white transition-transform hover:translate-y-[-2px] hover:shadow-lg hover:shadow-red-600/20">
